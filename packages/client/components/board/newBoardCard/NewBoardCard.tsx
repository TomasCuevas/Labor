  ...
  return (
    <li className="h-20 w-full">
      <button
        ...
        className="relative flex h-full w-full items-center justify-center gap-1 overflow-hidden rounded-md bg-dark p-4 shadow-md shadow-black/20 hover:shadow-black/30 lg:justify-start lg:px-8"
      >
